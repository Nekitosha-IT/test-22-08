...
function certificateStatus(
    ...
    if ($validValue !== null) {
        ...
        if (
            $validValue === true ||
            strtolower((string)$validValue) === 'true' ||
            strtolower((string)$validValue) === 'valid'
        ) {
            $isValid = true;
        }
        ...
        if (
            $validValue === false ||
            strtolower((string)$validValue) === 'false' ||
            strtolower((string)$validValue) === 'invalid'
        ) {
            $isValid = false;
        }
    }
